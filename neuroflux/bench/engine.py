...
class AFPMBenchEngine:
    ...
    def _seed_entries(self) -> list[AFPMBenchEntry]:
        return [
            AFPMBenchEntry(
                ...
                topology="modular aerospace axial-flux permanent-magnet generator",
    ...
    def _red_team(self, entries: list[AFPMBenchEntry]) -> list[str]:
        ...
        return [
            ...
            "AFPM cassette segmentation may introduce torque ripple and acoustic noise.",
            ...
            "Segmented AFPM core and magnet eddy-current losses may exceed preliminary estimates.",
